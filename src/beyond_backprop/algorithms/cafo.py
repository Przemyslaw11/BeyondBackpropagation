...
def train_cafo_model(
    ...
    for i in range(num_blocks):
        ...
        current_block_input_fn = create_next_input_fn(i, current_block_input_fn)  # type: ignore[assignment]
...
def evaluate_cafo_model(
    ...
    device: torch.device,
    criterion: nn.Module | None = None,
    predictors: nn.ModuleList | None = None,
