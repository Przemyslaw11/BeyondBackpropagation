...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the MF YAML configuration file to update.",
    )
    parser.add_argument(
        "--study-name",
        type=str,
...
def main() -> None:
    ...
    logger.info("Starting MF configuration update process.")
    success = update_mf_config_from_optuna(
    ...
    if success:
        logger.info("MF Configuration update process completed successfully.")
        sys.exit(0)
    else:
